...
const ProductCard: React.FC<{ data: SectionItem }> = ({ data }) => {
  return (
    <Link href="/connect">
      <div className="md:min-w-52 max-w-56 h-full bg-[#F9FBFA] rounded-xl border border-[#999999]">
        ...
        <div className="p-3 flex flex-col gap-2">
          ...
          <div className="flex flex-row justify-between">
            <h1 className="font-semibold text-xs text-gray-500 md:w-2/5">
              Price {data?.price}
            </h1>
            <div className="hidden md:flex items-center gap-2 p-0.5 border-2 rounded-2xl">
