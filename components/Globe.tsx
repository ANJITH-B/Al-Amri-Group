    ...
    <div className="flex flex-col items-center justify-center py-20 h-screen bg-black relative w-full sm:min-h-[850px]">
      <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-[25rem] md:h-[40rem] px-4">
        ...
        >
          ...
          <p className="text-center text-sm md:text-lg font-normal text-neutral-200 max-w-lg mt-2 mx-auto">
            Your Trusted Wholesale Partner Since 2002
          </p>
          <p className="text-center text-xs md:text-sm font-normal text-neutral-700 dark:text-neutral-200 max-w-lg lg:max-w-2xl mt-2 mx-auto">
